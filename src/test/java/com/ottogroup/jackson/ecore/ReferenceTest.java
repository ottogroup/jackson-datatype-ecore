...
public class ReferenceTest {
  ...
  public void testWrite() throws IOException {
    ...
    final var resource = resourceSet.createResource(URI.createURI("tests/proxy.json"));
    ...
    final var tree = mapper.readTree(outputStream.toByteArray());
  ...
  public void testReadBackRef() throws IOException {
    ...
    final var tree = mapper.createArrayNode().add(maxNode).add(erikaNode);
    final byte[] bytes = mapper.writeValueAsBytes(tree);

    final var resource = resourceSet.createResource(URI.createURI("tests/testRead.json"));
  ...
  public void testWriteForeignResource() throws IOException {
    ...
    final var maxResource = resourceSet.createResource(URI.createURI("tests/max.json"));
    maxResource.getContents().add(max);
    final var erikaResource = resourceSet.createResource(URI.createURI("tests/erika.json"));
  ...
  public void testReadForeignResource() throws IOException {
    ...
    final var maxResource =
        resourceSet.createResource(URI.createURI("testReadForeignResource/max.json"));
    maxResource.getContents().add(max);
    ...
    final byte[] bytes = mapper.writeValueAsBytes(erikaNode);

    final var resource =
        resourceSet.createResource(URI.createURI("testReadForeignResource/erika.json"));
    resource.load(new ByteArrayInputStream(bytes), null);
    ...
    final var uniqueFriend = EcoreUtil.resolve(erika.getUniqueFriend(), resourceSet);
  ...
  public void testReadListOfReferences() throws IOException {
    final var maxNode =
        mapper
            ...
            .put("userId", "__MAX")
            .put("name", "Max")
            .set("friends", mapper.createArrayNode().add("#__ERIKA"));
    ...
    final var erikaNode =
        mapper
            ...
            .put("userId", "__ERIKA")
            .put("name", "Erika")
            .set("friends", mapper.createArrayNode().add("#__MAX"));

    final var tree = mapper.createArrayNode().add(maxNode).add(erikaNode);
    final byte[] bytes = mapper.writeValueAsBytes(tree);

    final var resource =
        resourceSet.createResource(URI.createURI("tests/testReadListOfReferences.json"));
    resource.load(new ByteArrayInputStream(bytes), null);
